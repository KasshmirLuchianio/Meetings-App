     ...
     2|"""Send v4 - MIME corect + testimonial real + fraze adevărate"""
    ...
    42|
    43|<p>Știu de la colegii din alte GAL-uri — se vorbește pe grupuri — că redactarea proceselor-verbale consumă între 12 și 15 ore pe lună pentru fiecare întâlnire. Este o problemă comună și, sincer, nerezolvată de multă vreme.</p>
    44|
   ...
   107|print("✅ Email trimis cu fraze corectate!")
   108|print()
   109|print("Ce s-a schimbat:")
   110|print('  ❌ "Am vorbit cu zeci de directori..."')
   111|print('  ✅ "Știu de la colegii din alte GAL-uri — se vorbește pe grupuri..."')
   112|print()
   113|print("👉 Verifică inbox-ul — e bine acum?")