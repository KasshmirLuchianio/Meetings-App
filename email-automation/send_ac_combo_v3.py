     ...
     2|"""Quick send v3 - MIME corect + testimonial real GAL Oamenii Deltei"""
    ...
    42|
    43|<p>Am vorbit cu zeci de directori de GAL-uri din țară și toți mi-au spus același lucru: <em>transcrierea și redactarea PV-urilor consumă între 12 și 15 ore pe lună.</em></p>
    44|
   ...
   107|print("✅ Email trimis cu testimonial REAL - GAL Oamenii Deltei!")
   108|print(f"   Către: {DEST}")
   109|print(f"   Testimonial: Aplicația este excepțională...")
   110|print()
   111|print("👉 Verifică inbox-ul — se vede acum și conținutul, și logo, și video?")